...
def ai_assistant_tab(df_filtered):
    ...
    if prompt := st.chat_input("Enter your question about the data"):
        ...
        event_handler = MyEventHandler(chat_container=chat_container)
                    ...
                    for attachment in message.attachments:
                        if attachment.object == 'file':
                            ...
                            if attachment.filename.endswith(('.png', '.jpg', '.jpeg')):
                                ...
                                href = f'<a href="data:file/{attachment.filename.split(".")[-1]};base64,{b64}" download="{attachment.filename}">Download {attachment.filename}</a>'
                                st.session_state.chat_history[-1]['content'] += f"\n\n{href}"
        except Exception as e:
